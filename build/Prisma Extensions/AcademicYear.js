...
exports.AcademicYearExtension = void 0;
...
exports.AcademicYearExtension = prisma.$extends({
    model: {
        acadamicYear: {
        ...
        acadamicYear: {
            async update({ model, operation, args, query }) {
                ...
                if (args.data.fromYear) {
                    args.data.fromYear = new Date(args.data.fromYear);
                }
                if (args.data.toYear) {
                    args.data.toYear = new Date(args.data.toYear);
                }
                return query(args);
            },
        },
