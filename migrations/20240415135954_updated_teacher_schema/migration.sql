...
-- AddForeignKey
ALTER TABLE "Teacher" ADD CONSTRAINT "Teacher_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "Admin"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Teacher" ADD CONSTRAINT "Teacher_acadamicTermId_fkey" FOREIGN KEY ("acadamicTermId") REFERENCES "AcadamicTerm"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "YearGroup" ADD CONSTRAINT "YearGroup_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "Admin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
